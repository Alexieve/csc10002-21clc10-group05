...
void creatSechoolYear(schoolYear* &headSchoolYear);
...
void viewCourseInfor(dataCourse &dataC, Course*& headCourse, Account*& curAccount, Account* &headAccount, schoolYear* &curSchoolYear, schoolYear* &headSchoolYear, bool studentMode);
